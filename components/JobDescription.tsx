          ...
          return (
            <div key={i} className="mt-8 text-center">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-8 py-4 bg-white text-[#0B0B1A] font-bold text-base rounded-xl hover:bg-white/90 transition-all duration-300 hover:shadow-[0_0_40px_rgba(168,85,247,0.5)] hover:-translate-y-0.5 cursor-pointer"
              >
                Apply Now
